...
- We have the system up and running. We are using a group member’s Raspberry Pi as a server to run the website we will be using for Peer Pad. The server will run our website but will also hold all the documents submitted by users. We are not using AWS so no need to deploy a container for our server.
...
![Look and Feel](https://github.com/xlilos/CS386-Group2/blob/main/deliverables/Media/Deliv_4_Look_and_feel.png)
...
[Demo](https://www.youtube.com/watch?v=n-VXuXhOc10)
